...
GLfloat size = 2;
Podloze podloze;
Wheel wheel1 = Wheel(15, 15 , 70, 0, 0 + 19);
Wheel wheel2 = Wheel(15, 15, 70, 60, 0 + 19);
Wheel wheel3 = Wheel(15, 15 , -40, 0, 0 + 19);
Wheel wheel4 = Wheel(15, 15 , -40, 60, 0+ 19);
SideSciana sciana1 = SideSciana(150, 20, 30, -70, 60, 0+19);
SideSciana sciana2 = SideSciana(150, 20, 30, -70, 0, 0+19);
//Front front = Front(60, 75, 20, -70, 5, 0);
Back back = Back(10, 80, 30, -70, 0, 0+19);
...
void RenderScene(void)
{
	...
	glBegin(GL_QUADS);
	glNormal3d(0, 0, 1);
	glTexCoord2d(1.0, 1.0); glVertex3d(-100, 3.3, -196);
	glTexCoord2d(0.0, 1.0); glVertex3d(78, 3.3, -196);
	glTexCoord2d(0.0, 0.0); glVertex3d(78, 3.3, 196);
	glTexCoord2d(1.0, 0.0); glVertex3d(-100, 3.3, 196);
	glEnd();
	...
	LPARAM  lParam)
{
	...
	case WM_CREATE:
		...
		bitmapData = LoadBitmapFile((char*)"sideSciana.bmp", &bitmapInfoHeader);
		...
		bitmapData = LoadBitmapFile((char*)"grass.bmp", &bitmapInfoHeader);
